Project by Ambuj Guhey
204101005
IMPORTANT NOTE :
1)Training and testing files contains 10 utterances of same vowel per file.
2)Running time of whole programme is more than 1 minutes (including testing and training). 

SO, PLEASE WAIT AFTER HITTING THE RUN BUTTON (OUTPUT WILL BE DISPLAYED AFTER   1  MINUTES).

3) Overall accuracy is 96%  (48/50 vowels are recognised correctly {a-100%, e-90%, i-100%, o-90%, u-100%} ).
